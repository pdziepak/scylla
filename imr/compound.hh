...
public:
    ...
    GCC6_CONCEPT(requires requires(Writer wr, internal::structure_sizer<no_op_continuation, Members...> ser, Args... args) {
        { wr(ser, args...) } -> size_t;
    })
    ...
    template<typename Writer, typename... Args>
    GCC6_CONCEPT(requires requires(Writer wr, internal::structure_serializer<no_op_continuation, Members...> ser, Args... args) {
        { wr(ser, args...) } -> uint8_t*;
    })
