...
public:
    ...
    using raw_pointer_type = std::conditional_t<is_const == const_view::yes,
...
using value_view = basic_value_view<const_view::yes>;
using value_mutable_view = basic_value_view<const_view::no>;
