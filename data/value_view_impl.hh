...
inline typename basic_value_view<is_const>::iterator& basic_value_view<is_const>::iterator::operator++()
{
    if (!_next) {
        _view = fragment_type();
...
template<const_view is_const>
inline bool basic_value_view<is_const>::operator==(const basic_value_view& other) const noexcept
{
...
template<const_view is_const>
inline bool basic_value_view<is_const>::operator==(bytes_view bv) const noexcept
{
    bool equal = true;
...
template<const_view is_const>
inline bytes basic_value_view<is_const>::linearize() const
{
...
inline decltype(auto) basic_value_view<is_const>::with_linearized(Function&& fn) const
{
    bytes b;
    bytes_view bv;
    if (is_fragmented()) {
