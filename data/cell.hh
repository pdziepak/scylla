...
struct cell {
    ...
    struct variable_value {
        ...
        static auto write(FragmentRange&& value, bool force_internal = false) noexcept;
        ...
        static auto write(size_t size, bool force_internal = false) noexcept;
        ...
        static basic_value_view<is_const> do_make_view(structure::basic_view<is_const> view, bool external_storage);
    ...
    static auto make_live(const type_info& ti, api::timestamp_type ts, FragmentRange&& value, bool force_internal = false) noexcept {
        return [&ti, ts, value, force_internal] (auto&& serializer, auto&& allocations) noexcept {
            auto after_expiring = serializer
                .serialize(imr::set_flag<tags::live>(),
                           imr::set_flag<tags::empty>(value.size() == 0),
...
private:
    ...
    atomic_cell::basic_view<is_const> cell_view() const noexcept {
...
public:
    ...
    basic_value_view<is_const> value() const noexcept {
        auto ctx = make_context();
        return cell_view().template get<tags::value>(ctx).visit(utils::make_visitor(
                [] (fixed_value::basic_view<is_const> view) { return basic_value_view<is_const>(view, 0, nullptr); },
                [&] (variable_value::structure::basic_view<is_const> view) {
                    return variable_value::make_view(view, flags_view().template get<tags::external_data>());
                },
                [] (...) -> basic_value_view<is_const> { abort(); }
        ), ctx);
    }
