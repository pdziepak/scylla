...
template<bool... Vs>
constexpr bool do_conjunction() noexcept {
    bool result = true;
...
template<bool... Vs>
static constexpr bool conjunction = internal::do_conjunction<Vs...>();

template<template <class> typename Predicate, typename... Ts>
static constexpr bool all_of = conjunction<Predicate<Ts>::value...>;
