...
void memtable::memtable_encoding_stats_collector::update(const deletable_row& dr) {
    update(dr.marker());
...
void memtable::memtable_encoding_stats_collector::update(const mutation_partition& mp) {
